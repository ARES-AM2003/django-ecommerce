...
ALLOWED_HOSTS = [ 'localhost', '127.0.0.1','django-ecommerce-production-d320.up.railway.app']


CSRF_TRUSTED_ORIGINS = ['https://django-ecommerce-production-d320.up.railway.app']
