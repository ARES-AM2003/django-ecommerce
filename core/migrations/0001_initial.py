# Generated by Django 5.1.7 on 2025-04-05 16:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_order_id', models.CharField(blank=True, max_length=500, null=True)),
                ('esewa_payment_id', models.CharField(blank=True, max_length=500, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
